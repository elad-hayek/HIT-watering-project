-- ============================================================================
-- Migration 002: RBAC System and Area Permissions
-- Description: Adds role-based access control and area-level permission system
-- Date Created: 2026-03-15
-- Prerequisites: Migration 001 (initial schema) must be run first
-- ============================================================================
...
-- ============================================================================
-- This column is NOT added if it already exists (safe for re-running)
...
-- Maps which users have access to which areas with specific permissions
-- Permission levels: 'read' (view only) or 'update' (add/edit/delete plants)
-- ============================================================================
...
CREATE TABLE user_area_mapping (
  ...
  `permission` ENUM('read', 'update') DEFAULT 'read',
...
-- Assign roles to the sample users created in migration 001
-- ============================================================================
...
-- ============================================================================
-- Step 4: Create role_definitions reference table
-- This table documents the role hierarchy and permissions
-- ============================================================================
...
-- ============================================================================
-- Step 5: Insert role definitions
-- ============================================================================
...
-- Migration complete
-- Next steps:
-- - Restart the backend application to load the new RBAC middleware
-- - Assign users to areas using POST /api/users/{userId}/areas/{areaId}
-- - Optionally set individual area permissions (read/update)
-- ============================================================================
